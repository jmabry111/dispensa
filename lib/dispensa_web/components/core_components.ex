defmodule DispensaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DispensaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DispensaWeb.Gettext, "errors", msg, opts)
    end
  end
